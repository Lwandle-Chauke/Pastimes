...
if(isset($_POST['submit'])){
   ...
   $select = $conn->prepare("SELECT * FROM `tblusers` WHERE email = ?");
   ...
   if ($result->num_rows > 0) {
      ...
      if($pass != $cpass){
         ...
         $insert = $conn->prepare("INSERT INTO `tblusers`(name, email, password, user_type, image) VALUES(?,?,?,?,?)");
...
<form action="" enctype="multipart/form-data" method="POST">
   ...
   <!-- User Type Selection -->
   <label for="user_type"><b>Select User Type:</b></label>
