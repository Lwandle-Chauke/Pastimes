...
if (isset($_POST['update_order'])) {
   ...
   $update_orders = $conn->prepare("UPDATE `tblorders` SET payment_status = ? WHERE id = ?");
...
if (isset($_GET['delete'])) {
   ...
   $delete_orders = $conn->prepare("DELETE FROM `tblorders` WHERE id = ?");
...
<section class="placed-orders">
   ...
   <div class="box-container">
      ...
      ?>
      <div class="box">
         <p> ordernum: <span><?= $fetch_orders['id']; ?></span> </p>
         <p> session ID: <span><?= $fetch_orders['user_id']; ?></span> </p>
